...
| **Voice Builder**                 | Use live voice commands from the VS Code canvas toolbar to generate and apply RocketRide pipeline edits. See [Voice Builder](docs/README-voice-builder.md).                                                                           |
